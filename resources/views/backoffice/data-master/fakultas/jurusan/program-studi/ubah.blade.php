        ...
        <div class="col-md-6">
            ...
            <div class="card">
                <div class="card-header bg-primary">
                    <h3 class="card-title">Form Ubah Program Jurusan</h3>
                ...
                <div class="card-body">
                    <form action="/backoffice/data-master/fakultas/{{ $fakultas->id }}/jurusan/{{ $jurusan->id }}/prodi/{{ $prodi->id }}/ubah" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label for="gelar_lulusan">Gelar Lulusan <span class="text-danger">*</span></label>
                            <input type="text" name="gelar_lulusan" id="gelar_lulusan" class="form-control @if ($errors->has('gelar_lulusan')) is-invalid @endif" value="{{ $prodi->gelar_lulusan ?? old('gelar_lulusan') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kode_program_studi" id="kode_program_studi" class="form-control @if ($errors->has('kode_program_studi')) is-invalid @endif" value="{{ $prodi->kode_program_studi ?? old('kode_program_studi') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="program_studi" id="program_studi" class="form-control @if ($errors->has('program_studi')) is-invalid @endif" value="{{ $prodi->program_studi ?? old('program_studi') }}">
                        ...
                        <div class=" text-center">
                            ...
                            <button type="submit" class="btn btn-warning" style="width: 50%"> 
                                <i class="fas fa-edit"></i> Ubah Program Studi
                            </button>
                        </div>
                    </form>
                </div>
