...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Tambah Mata Kuliah {{ $prodi->program_studi }}</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/backoffice/dashboard">Beranda</a></li>
                    <li class="breadcrumb-item"><a href="/backoffice/data-master/prodi-matkul/umum">Matkul {{ $prodi->program_studi }}</a></li>
        ...
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="/backoffice/data-master/prodi-matkul/prodi/{{ $prodi->id }}/tambah" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class=" text-center">
                            <a href="/backoffice/data-master/prodi-matkul/prodi/{{ $prodi->id }}" class="btn btn-default" title="Kembali">
