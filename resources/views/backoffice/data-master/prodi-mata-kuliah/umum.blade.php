        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Mata Kuliah Umum</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="/backoffice/data-master/prodi-matkul/umum-tambah" class="btn btn-success btn-sm" title="Tambah Prodi Mata Kuliah">
                        ...
                        <tbody>
                            @foreach($prodiMatkuls as $key => $prodiMatkul)
                                <tr>
                                    ...
                                    <td>
                                        <a href="/backoffice/data-master/prodi-matkul/{{ $prodiMatkul->id }}/umum/ubah-semester" class="btn btn-warning btn-sm" title="Ubah">
