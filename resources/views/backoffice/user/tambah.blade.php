    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/backoffice/pengguna/tambah" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control @if ($errors->has('status')) is-invalid @endif">
                                ...
                                <option value="2" {{ old('status') == 2 ? 'selected' : '' }}>Operator</option>
                                <option value="3" {{ old('status') == 3 ? 'selected' : '' }}>Pegawai</option>
                            </select>
